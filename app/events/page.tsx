                ...
                <div className="flex flex-col w-full max-w-[1200px] mt-15 px-4 md:px-0">
                    ...
                    <div className='flex flex-col gap-4'>
                        { filteredData ?
                            ...
                            : <h2 className='text-center col-span-full'>Select parametrs above</h2>
                        }

                        {filteredData?.length == 0 ? <h2 className='text-center col-span-full'>Unfortunately, no events founds using paramaters above 🥲</h2> : null}
